...
public class ClasseCicloDescricaoConverter implements Converter{
	...
	public Object getAsObject(FacesContext context, 
		...
		if(!propriedades[1].isEmpty()){
			classe.setDescricao(propriedades[1]);
		}if(!propriedades[2].isEmpty()){
			classe.setCiclo(propriedades[2]);
		}
	...
	public String getAsString(FacesContext context, UIComponent component, Object obj) {
		...
		String descricao = classe.getDescricao() == null ? "" : classe.getDescricao();
		String ciclo = classe.getCiclo() == null ? "" : classe.getCiclo();
		return id +"#" +descricao +"#"+ciclo;
	}
